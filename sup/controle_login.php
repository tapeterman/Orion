                        ...
                        <div class="ibox-content">
                            <div class="row">
                                ...
                                <div class="col-sm-4 m-b-xs">
                                    <select id="supervisor" class="input-sm form-control input-s-sm inline" onchange="fazerRequisicao('tabelas/tabela_prazo_supervisor.php?data='+this.value, 'tabela_prazo_supervisor')">
                                        <option value='TODOS'><center>TODOS</center></option>
                                        <?php 
                                            set_time_limit(0);
                                            $sql = "SELECT distinct SUPERIOR 
                                ...
                                <div class="col-sm-4 m-b-xs">
                                    <select id="datamaxima" class="input-sm form-control input-s-sm inline" onchange="fazerRequisicao('tabelas/tabela_login_iride.php?data='+this.value+'&supervisor='+ supervisor.options[supervisor.selectedIndex].value, 'tabela_login_iride')">
                                        <?php 
                                            set_time_limit(0);
