                ...
                <li class="nav-header">
                    <div class="dropdown profile-element"> 
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="text-muted text-xs block"><?php echo $permissao ?><b class="caret"></b>
                            </span> </span> </a>
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li>
                            ...
                            <ul class="nav nav-third-level">
                                <li><a href="abertos_online_supervisor.php">Abertos Operador</a></li>
                                <li><a href="finalizados_online_supervisor.php">Finalizados por Operador</a></li>
                                <li><a href="start.php">Manifestos sem Start</a></li>
                                <li><a href="fcr.php">FCR</a></li>
                                <li><a href="recorrente.php">Recorrente</a></li>
                                <li><a href="prazo.php">Prazo por Operador</a></li>
                                <li><a href="controle_login.php">Controle Login</a></li>
                                <li><a href="tempos_huawei.php">Tempos Huawei</a></li>
                                <li><a href="agenda_para_operador.php">Agenda Operador</a></li>
                            </ul>
