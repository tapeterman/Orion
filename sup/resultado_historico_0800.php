            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><strong>Historico Resultados 0800</strong></li>
                    </ol>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>Historico Resultados 0800</h5>
                            ...
                            <div class="ibox-content">
                                <div class="row">
                                        ...
                                        <select id="supervisor" class="input-sm form-control input-s-sm inline">
                                            ...
                                            <?php set_time_limit(0);
                                                $sql = "SELECT distinct SUPERVISOR_RESPONSAVEL as SUPERVISOR
                                                        ...
                                                        where CAMPANHA_RESPONSAVEL = 'OUVIDORIA 0800'
                                    ...
                                    <button class="btn btn-primary col-sm-2" type="button" 
                                        onclick="fazerRequisicao('tabelas/tabela_resultado_historico_0800.php?mes='+mes.options[mes.selectedIndex].value+'&supervisor='+ supervisor.options[supervisor.selectedIndex].value, 'tabela_resultado_historico_0800')">
                                    <i class="fa fa-check"></i>Atualizar
                                    </button>
                                </div>
                                <div id="tabela_resultado_historico_0800" class="table-responsive" >
                                </div>
                            </div>
                       </div>
                    </div>
