    ...
    <body>
        <?php include('header.php');?>
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Relatorios Histórico</h2>
                    <ol class="breadcrumb">
                        <li><a href="home.php">Home</a></li>
                        <li><a>Relatorios Historico</a></li>
                        <li class="active"><strong>Indicadores Consolidado por Operador</strong></li>
                    </ol>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>Indicadores Consolidado por Operador</h5>
                            ...
                            <div class="ibox-content">
                                <div class="row">
                                        ...
                                        <select id="supervisor" class="input-sm form-control input-s-sm inline">
                                            ...
                                            <?php set_time_limit(0);
                                                $sql = "SELECT distinct SUPERVISOR_RESPONSAVEL as SUPERVISOR
                                                        ...
                                                        WHERE SUPERVISOR_RESPONSAVEL NOT IN ('BCC','', 'NET')
                                                        AND VALIDO = 1 
                                    ...
                                    <button class="btn btn-primary col-sm-2" type="button" 
                                        onclick="fazerRequisicao('tabelas/tabela_operador_historico.php?mes='+mes.options[mes.selectedIndex].value+'&supervisor='+ supervisor.options[supervisor.selectedIndex].value, 'tabela_operador_historico')">
                                    <i class="fa fa-check"></i>Atualizar
                                    </button>
                                </div>
                                <div id="tabela_operador_historico" class="table-responsive" >
                                </div>
                            </div>
                       </div>
                    </div>
