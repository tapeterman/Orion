                            ...
                            <div class="ibox-content">
                                <div class="row">
                                        ...
                                        <select id="supervisor" class="input-sm form-control input-s-sm inline">
                                            ...
                                            <?php set_time_limit(0);
                                                $sql = "SELECT distinct SUPERVISOR_RESPONSAVEL as SUPERVISOR
                                                        ...
                                                        where CAMPANHA_RESPONSAVEL = 'OUVIDORIA N2'
                                    ...
                                    <button class="btn btn-primary col-sm-2" type="button" 
                                        onclick="fazerRequisicao('tabelas/tabela_resultado_historico_N2.php?mes='+mes.options[mes.selectedIndex].value+'&supervisor='+ supervisor.options[supervisor.selectedIndex].value, 'tabela_resultado_historico_N2')">
                                    <i class="fa fa-check"></i>Atualizar
                                    </button>
                                </div>
                                <div id="tabela_resultado_historico_N2" class="table-responsive" >
                                </div>
                            </div>
                       </div>
                    </div>
