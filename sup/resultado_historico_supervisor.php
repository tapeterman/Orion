            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><strong>Indicadores Consolidado por Supervisor</strong></li>
                    </ol>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>Indicadores Consolidado por Supervisor</h5>
                            ...
                            <div class="ibox-content">
                                <div class="row">
                                    ...
                                    <button class="btn btn-primary col-sm-2" type="button" 
                                        onclick="fazerRequisicao('tabelas/tabela_supervisor_historico.php?mes='+mes.options[mes.selectedIndex].value, 'tabela_supervisor_historico')">
                                        <i class="fa fa-check"></i>Atualizar
                                    </button>
                                </div>
                                <div id="tabela_supervisor_historico" class="table-responsive" >
                                </div>
                            </div>
                       </div>
                    </div>
