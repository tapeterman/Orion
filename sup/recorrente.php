        ...
        <div class="wrapper wrapper-content animated fadeInRight">
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                ...
                                <div class="col-sm-2 m-b-xs">
                                    <select id="datamaxima" class="input-sm form-control input-s-sm inline" 
                                            onchange="fazerRequisicao('tabelas/tabela_recorrente_dia.php?data='+this.value, 
                                            'tabela_recorrente_dia')">
                                        <option value='<?php echo date('d/m/Y', strtotime('+0 days'));;?>'>
                                            <center><?php echo date('d/m/Y', strtotime('+0 days'));;?></center>
                                        </option>
                                        <option value='<?php echo date('d/m/Y', strtotime('+1 days'));;?>'>
                                            <center><?php echo date('d/m/Y', strtotime('+1 days'));;?></center>
                                        </option>
                                        <option value='<?php echo date('d/m/Y', strtotime('+2 days'));;?>'>
                                            <center><?php echo date('d/m/Y', strtotime('+2 days'));;?></center>
                                        </option>
                                        <option value='<?php echo date('d/m/Y', strtotime('+3 days'));;?>'>
                                            <center><?php echo date('d/m/Y', strtotime('+3 days'));;?></center>
                                        </option>
                                        <option value='<?php echo date('d/m/Y', strtotime('+4 days'));;?>'>
                                            <center><?php echo date('d/m/Y', strtotime('+4 days'));;?></center>
                                        </option>
                                        <option value='<?php echo date('d/m/Y', strtotime('+5 days'));;?>'>
                                            <center><?php echo date('d/m/Y', strtotime('+5 days'));;?></center>
                                        </option>
                                    </select>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Recorrente por supervisor Total</h5>
                            <div class="ibox-tools">
                                <a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                <a class="fullscreen-link"><i class="fa fa-expand"></i></a>
                                <a class="close-link"><i class="fa fa-times"></i></a>
