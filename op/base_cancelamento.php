...
<html>
    ...
    <body onload="fazerRequisicao('tabelas/tabela_cancelamento_historico.php?mes=10', 'tabela_cancelamento_historico')">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 m-b-xs">
                                    <select id="mes" class="input-sm form-control input-s-sm inline" 
                                        onchange="fazerRequisicao('tabelas/tabela_cancelamento_historico.php?mes='+this.value, 'tabela_cancelamento_historico')">
