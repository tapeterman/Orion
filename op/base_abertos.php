                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                        <?php 
                                            set_time_limit(0);
                                            $sql = "SELECT ID_DETALHE_MANIFESTACAO, NM_CLIENTE, CPF_CNPJ,
                                                  DATE_FORMAT(STR_TO_DATE(`DH_ABERTURA`, '%d/%m/%Y'),'%d/%m/%Y') AS DH_ABERTURA,
                                                  DUPLICIDADE, RECORRENTE, ODC, STATUS_VENCIMENTO, ICR, 
                                                  date_format(DT_VENCIMENTO,'%d/%m/%Y') as DT_VENCIMENTO, 
                                                  HR_VENCIMENTO, NOME,  SUPERVISOR, AREA, TIPO, `DS_FORMA_CONTATO`
                                        ...
                                        ?> 
                                                <tr>
                                                    <td><center><?php echo $registro['ID_DETALHE_MANIFESTACAO'];?></center></td>
