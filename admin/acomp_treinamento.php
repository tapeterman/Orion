              ...
              <div class="ibox-content">
                <table class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                    <?php
                      set_time_limit(0);
                      $sql = "SELECT SKILL , ASSUNTO, COUNT(ASSUNTO) AS PROGRAMADO, 
                    ...
                    ?> 
                            <tr>
                              <td scope="row"><center><?php echo $registro['SKILL'];?></center></td>
                              ...
                              <td><center><?php echo $registro['PROGRAMADO']-$registro['QTD_INATIVO']-$registro['REALIZADO'];;?></center></td>
                          ...
                          <table class="table table-striped table-bordered table-hover dataTables-example" >
                            <thead>
                              <tr>
                                ...
                                <th><center>TURNO OPERADOR</center></th>
                                ...
                                <th><center>CPF INSTRUTOR</center></th>
                            ...
                            <tbody>
                              <?php set_time_limit(0);
                                ...
                                <tr>
                                  ...
                                  <td><center><?php echo $registro['CPF_INSTRUTOR'];?></center></td>
      ...
      $(document).ready(function(){
          ...
          "language": {
              ...
              buttons: [
                  { extend: 'copy'},
                  {extend: 'csv'},
                  {extend: 'excel', title: 'base'},
                  {extend: 'pdf', title: 'base'},
