                        ...
                        <div class="ibox-content">
                            <div class="row">
                                    ...
                                    <select id="mes" class="input-sm form-control input-s-sm inline">
                                        <?php set_time_limit(0);
                                            $sql = "SELECT distinct DATE_FORMAT(DATA, '%m-%Y') AS 'MES' 
                                                    FROM tb_diario_bordo
                                                    order by DATE_FORMAT(DATA, '%m-%Y') desc";
                                ...
                                <button class="btn btn-primary col-sm-2" type="button" 
                                    onclick="fazerRequisicao('tabelas/tabela_diario_bordo.php?mes='+mes.options[mes.selectedIndex].value, 'tabela_diario_bordo')">
                                    <i class="fa fa-check"></i>Atualizar
                                </button>
                            </div>
                            <div id="tabela_diario_bordo" class="table-responsive" >
                            </div>
                        </div>
                   </div>
                </div>
