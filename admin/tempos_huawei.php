                        ...
                        <div class="ibox-content">
                            <div class="row">
                                ...
                                <button class="btn btn-primary col-sm-2" type="button" 
                                        onclick="fazerRequisicao('tabelas/tabela_tempos_huawei.php?DATA='+DATA.options[DATA.selectedIndex].value+'&supervisor='+ supervisor.options[supervisor.selectedIndex].value, 'tabela_tempos_huawei')">
