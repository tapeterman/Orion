            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a>Usuarios</a></li>
                        <li class="active"><strong>Usuarios Cadastrados</strong></li>
                    </ol>
                </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?> 
                                                    <tr>
                                                        ...
                                                        <td><center><?php echo $registro['Permissao'];?></center></td>
                                                        <td><center><?php echo $registro['Status_roteamento'];?></center></td>
                                                        <td><center><?php echo $registro['Status'];?></center></td>
                                                        <td><center></center>
                                                            <div align="left">
                                                                <a href="editar_usuarios.php?almope=<?php echo $registro['Almope'];?>" toolTip="Editar">
                                                                    <i class="fa fa-wrench"></i>
                                                                </a>
                                                            </div>
                                                            <div align="right">
                                                                <a href="#">
                                                                    <i class="fa fa-times" toolTip="Excluir"></i>
                                                                </a>
                                                            </div>
                                                        </center></td>
                                                    </tr>
