  ...
  <tbody>
    ...
    ?>
            <tr>
              ...
              <td><center><a href="atualizar_treinamento.php?status=PRESENTE&almope=<?php echo $registro['ALMOPE'];?>&assunto=<?php echo $assunto;?>"><i class="fa fa-check-square-o fa-2x"></i></a>
              <a href="atualizar_treinamento.php?status=INATIVO&almope=<?php echo $registro['ALMOPE'];?>&assunto=<?php echo $assunto;?>"><i class="fa fa-times-rectangle fa-2x"></i></a></button>
              </td>
            </tr>
          <?php }}?>
            <tfoot>
