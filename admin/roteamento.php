...
<html>
    ...
    <body onload="fazerRequisicao('tabelas/tabela_roteamento.php?data=Data', 'tabela_roteamento')">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><strong>Média Roteamento</strong></li>
                </ol>
            </div>
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-sm-2 m-b-xs">
                                    <label class="btn-sm btn-white" for="data">Data Abertura</label>
                                </div>
                                <div class="col-sm-4 m-b-xs">
                                    <select id="data" class="input-sm form-control input-s-sm inline" onchange="fazerRequisicao('tabelas/tabela_roteamento.php?data='+this.value, 'tabela_roteamento')">
                                        <?php set_time_limit(0);
                                            $sql = "SELECT DISTINCT DATE_FORMAT(STR_TO_DATE(`DH_ABERTURA`,'%d/%m/%Y'),'%d/%m/%Y') AS DATA
                                                    FROM `tb_portal_online` 
                                                    WHERE `EMPRESA`= 'ALMAVIVA'
                                                    AND `DS_FORMA_CONTATO` not IN ('BKO') 
                                                    ORDER BY STR_TO_DATE(`DH_ABERTURA`,'%d/%m/%Y') DESC";
                            ...
                            <div id="tabela_roteamento" class="table-responsive" ></div>
                        </div>
                    </div>
                </div>
            </div>
