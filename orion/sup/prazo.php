            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><strong>Prazo por Operador</strong></li>
                    </ol>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 m-b-xs">
                                        <select id="datamaxima" class="input-sm form-control input-s-sm inline" 
                                            onchange="fazerRequisicao('tabelas/tabela_prazo_supervisor.php?data='+this.value,'tabela_prazo_supervisor')">
                                            <?php
                                                set_time_limit(0);
                                                $sql = "select distinct DATE_FORMAT(`VENCIMENTO`, '%d/%m/%Y') as VENCIMENTO  from `tb_prazo_online` order by VENCIMENTO ";
                                ...
                                <div id="tabela_prazo_supervisor" class="table-responsive" >
                            </div>
                        </div>
                    </div>
                </div>
