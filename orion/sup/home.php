            ...
            <div class="ibox-content">
              ...
              <div class="stat-percent font-bold text-success">
                ...
                if(!$resultado)
                  ...
                  echo round(@($registro['RDP']/($registro['Recebido']-$registro['ADP'])*100),2); 
                }?>% 
        ...
        <div class="col-lg-3">
          <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
              <h1 class="no-margins">                              
                <?php
                  $sql = "SELECT count(*) as Quantidade FROM `vw_resolvidas_online` 
                  ...
                  <tbody>
                    ...
                    ?>        
                          <tr>
                            ...
                            <td class=<?php 
                              if($registro['OPORTUNIDADE']>95) echo'"text-navy"'; 
                              else echo '"text-warning"';?>> <i class=<?php 
                              if($registro['OPORTUNIDADE']>95) echo'"fa fa-level-up"'; 
                              else echo '"fa fa-level-down"';?>></i>
                              <strong><?php echo round($registro['OPORTUNIDADE'],2);?>%</strong>
                            </td> 
                          </tr>
                    <?php } }?>          
                  </tbody>
            ...
            <div class="col-lg-12">
              <div class="tabs-container">
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#ICR">ICR</a></li>
                    <li class=""><a data-toggle="tab" href="#START">Pendentes de Start</a></li>
                    <li class=""><a data-toggle="tab" href="#ABERTOS">Em aberto</a></li>
                    <li class=""><a data-toggle="tab" href="#RECORRENTE">Recorrentes</a></li>
                    <li class=""><a data-toggle="tab" href="#FILA">Em aberto por Fila</a></li>
                </ul>
                <div class="tab-content">
                  <div id="ICR" class="tab-pane active">
                        ...
                        <tbody>
                          ...
                          ?> 
                                <tr>
                                  ...
                                  $acumulado=$acumulado + $registro['TOTAL'];?>
                                </tr>
                          <?php } }?>          
                              <tr>
                  ...
                  <div id="RECORRENTE" class="tab-pane">
                    <div class="panel-body">
                      <table class="table table-bordered">
                        <thead>
                          <tr>
