                            ...
                            <div class="ibox-content">
                                <div class="row">
                                    ...
                                    <button class="btn btn-primary col-sm-2" type="button" 
                                        onclick="fazerRequisicao('tabelas/tabela_resultado_historico.php?mes='+mes.options[mes.selectedIndex].value+'&supervisor='+ supervisor.options[supervisor.selectedIndex].value, 'tabela_resultado_historico')">
