                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Abertos Online por supervisor</h5>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                        <?php set_time_limit(0);
                                            $sql = "SELECT DISTINCT `SUPERVISOR`, COUNT(*) as TOTAL, 
                                                    SUM(CASE WHEN STATUS_VENCIMENTO in('VENCIDO +20 DIAS', 'VENCIDO +10 DIAS','VENCIDO +5 DIAS',
                                                        'VENCIDO ATÉ 5 DIAS')  THEN 1 ELSE 0 END) AS 'VENCIDOS',
                                                    ...
                                                    SUM(CASE WHEN STATUS_VENCIMENTO = 'VENCE D+5' THEN 1 ELSE 0 END) AS 'VENCE D+5' 
                                                    from `tb_portal_online`
                                                    where empresa='ALMAVIVA' and `DS_FORMA_CONTATO`<>'BKO' group by SUPERVISOR";    
