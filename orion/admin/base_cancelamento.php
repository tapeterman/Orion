...
<html>
    ...
    <body onload="fazerRequisicao('tabelas/tabela_cancelamento_historico.php?mes=10&supervisor=TODOS', 'tabela_cancelamento_historico')">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><strong>Base Cancelamento Receita</strong></li>
                    </ol>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Base Cancelamento Receita</h5>
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                ...
                                <div class="col-sm-4 m-b-xs">
                                    <select id="supervisor" class="input-sm form-control input-s-sm inline" 
                                        onclick="fazerRequisicao('tabelas/tabela_cancelamento_historico.php?mes='+this.value+'&supervisor='+ supervisor.options[supervisor.selectedIndex].value, 'tabela_cancelamento_historico')">
                                ...
                                <div class="col-sm-4 m-b-xs">
                                    <select id="mes" class="input-sm form-control input-s-sm inline" 
                                        onchange="fazerRequisicao('tabelas/tabela_cancelamento_historico.php?mes='+this.value+'&supervisor='+ supervisor.options[supervisor.selectedIndex].value, 'tabela_cancelamento_historico')">
                                        <option value='TODOS'><center>TODOS</center></option>
                                        <?php set_time_limit(0);
                                            $sql = "SELECT distinct DATE_FORMAT(DT_CANCELAMENTO, '%m-%Y') AS 'MES' 
                                                    FROM tb_cancelamento_operador";
                                                $resultado = mysqlI_query($link, $sql);
                                            if(!$resultado)
                                                echo 'ERRO';
                            ...
                            <div id="tabela_cancelamento_historico" class="table-responsive" ></div>
                        </div>
                    </div>
                </div>
            </div>
