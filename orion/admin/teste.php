...
<html>
    ...
    <body onload="fazerRequisicao('tabelas/tabela_login_iride.php?data=Data&supervisor=TODOS', 'tabela_login_iride')">
                            ...
                            <div class="ibox-content">
                                <div class="row">
                                    <div class="col-sm-2 m-b-xs">
                                        <label class="btn-sm btn-white" for="supervisor2">Supervisor</label>
                                    </div>
                                    <div class="col-sm-4 m-b-xs">
                                        <select id="supervisor2" class="input-sm form-control input-s-sm inline" onchange="<?php $levi=?>+this.value ">
                                    ...
                                    <div class="col-sm-2 m-b-xs">
                                        <label class="btn-sm btn-white" for="datamaxima">Mês</label>
                                    </div>
                                    <div class="col-sm-4 m-b-xs">
                                        <select id="datamaxima" class="input-sm form-control input-s-sm inline" onchange="fazerRequisicao('tabelas/tabela_resultado_historico.php?data='+this.value+'&supervisor='+ supervisor.options[supervisor.selectedIndex].value, 'tabela_resultado_historico')">
                                             <option value="10"><center>Outubro</center></option>
                                             <option value="9"><center>Setembro</center></option>
                                             <option value="8"><center>Agosto</center></option>
                                        </select>
                                    </div>
                                </div>
                                <div id="tabela_resultado_historico" class="table-responsive" >
                                    <script>
                                    ...
                                    <?php 
                                        $variavelphp = "<script>levi</script>";
                                        echo $variavelphp;
                                    ?>
                                </div>
                            </div>
