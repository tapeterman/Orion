        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a>Bases</a></li>
                    <li class="active"><strong>Base Prazo</strong></li>
                </ol>
            </div>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody> 
                                        <?php set_time_limit(0);
                                            ...
                                            $sql = "select `NM_CLIENTE`,`CPF_CNPJ`, date_format(`VENCIMENTO`,'%d/%m/%Y') as VENCIMENTO, 
                                                    `PRAZO`,`NOME`,`SUPERVISOR` FROM `tb_prazo_online";
                                        ...
                                        <tr>
                                            ...
                                            <td><center><?php echo $registro['VENCIMENTO'];?></center></td>
