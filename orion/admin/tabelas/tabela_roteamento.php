    ...
    <tbody>
      <?php
        ...
        if($_GET['data']=='Data')
          ...
          $data=$_GET['data'];
          $sql = "SELECT IF(HOUR(HR_VENCIMENTO)<=14, 'MANHA', 'TARDE') AS TURNO,
  ...
  <table class="table table-bordered table-striped table-hover">
    ...
    <tbody>
      <?php
        ...
        $totaln2=0;
        $sql = "SELECT Turno, 
              SUM(CASE WHEN Equipe in ('NIVEL 2','NIVEL 2 08:12') THEN 1 ELSE 0 END) AS ATIVOS_N2
      ...
      ?> 
          <tr>
            ...
            <td><center><?php echo round($recebido[$x]/$registro['ATIVOS_N2'],2);?></center></td>
            <?php $totaln2=$totaln2 + $registro['ATIVOS_N2'];
             $x=$x+1;?>
          </tr>
      <?php } }?> 
          <tr>
              ...
              <td><center><strong><?php echo round(@((($recebido[0]+$recebido[1])/$totaln2)),2);?></strong><center></td>
              <?php $media= round(@((($recebido[0]+$recebido[1])/$totaln2)),2);?>
          </tr>   
    </tbody>
  </table>
</div>
  ...
  <tbody>
    ...
    ?> 
          <tr>
            ...
            <td><center><?php echo  round($media-$registro['QTD'],0);?></center></td>
          </tr>
    <?php } }?> 
  </tbody>
</table>
