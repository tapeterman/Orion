                            ...
                            <div class="ibox-content">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 m-b-xs">
                                        <select id="mes" class="input-sm form-control">
                                    ...
                                    <button class="btn btn-primary col-sm-2" type="button" 
                                        onclick="fazerRequisicao('tabelas/tabela_operador_historico.php?mes='+mes.options[mes.selectedIndex].value, 'tabela_operador_historico')">
