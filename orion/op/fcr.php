        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><strong>FCR Online</strong></li>
                </ol>
            </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?> 
                                                        <tr>
                                                            ...
                                                            <td class=<?php if($registro['TOTAL']>30) echo'"text-navy"'; else echo '"text-danger"';?>><center><?php echo round($registro['TOTAL'],2);?>%</center></td>
                                                        </tr> 
                                                <?php } }?>              
                                            </tbody>
                                            <tfoot>
